function calculateBMI() {
    ...
    if (!isNaN(bmi)) {
        message = '<h2 style="color: white; margin-left: 550px;">Your BMI Result:</h2>';
        message += '<p style="color: white; margin-left: 550px; font-size: 17px; margin-top: 5px;"><strong>BMI:</strong> ' + bmi.toFixed(2) + '</p>';
        message += '<p style="color: white; margin-left: 550px; font-size: 17px">' + bmiCategory + '</p>';
    } else {
